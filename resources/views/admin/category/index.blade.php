                ...
                <div class="row">
                    <div class="card-heading d-flex justify-content-between">
                        <div>
                            ...
                            <p>
                                You can search the Category by <a href="#" class="card-heading-link">name</a> and
                    ...
                    {!! Form::open(['url' => 'super-admin/categories', 'method' => 'GET']) !!}
                    <div class="row">
                        <div class="col-md-11">
                            <div class="row">
                        ...
                        <div class="card-wrap form-block p-0">
                            <div class="block-header bg-header d-flex justify-content-between p-4">
                                ...
                                <div class="add-button">
                                    <a class="nav-link" href="{{url('super-admin/categories/create')}}"><i class="fa-solid fa-book-open"></i>&nbsp;&nbsp Add Category</a>
                                </div>
                            </div>
                                            ...
                                            <div class="col-12 table-responsive table-details">
                                                <table class="table" id="">
                                                    ...
                                                    <tbody id="student_list">
                                                        ...
                                                        <tr id="my-table-tr-{{$category->id}}">
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>{{$category->name}}</td>


                                                            <td class="text-center">{{config('custom.status')[$category->status]}}</td>
                                                            <td class="action-icons">
                                                                <ul class="icon-button d-flex">
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-item" href="{{url('super-admin/categories/'.$category->id.'/edit')}}" role="button"><i class="fa-solid fa-pen" data-bs-toggle="tooltip" data-bs-title="Edit"></i></a>
                                                                    </li>



                                                                    <li>
                                                                        <a class="dropdown-item" href="{{ url('super-admin/categories/delete/' . $category->id) }}"><i class="fa-solid fa-trash" data-bs-toggle="tooltip" data-bs-title="Delete"></i></a>
                                                                    </li>
