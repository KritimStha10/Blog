            ...
            <div class="col-sm-12 col-md-12 stretch-card">
                <div class="card-wrap form-block p-0">
                    <div class="block-header p-4">
                        <h3>Edit News</h3>
                        <p class="ms-4 mb-0">Fill the following fields to add new News.</p>
                        <div class="tbl-buttons">
                            <ul>
                                <li>
                                    <a href="{{url('super-admin/news')}}"><img src="{{url('frontend/cancel-icon.png')}}" alt="cancel-icon" /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row p-4 form-wrap">
                        {!! Form::open(['url' => 'super-admin/news/'.$new->id, 'class' => 'row g-2 ps-2 pe-0 me-0', 'id' => 'myForm', 'method' => 'POST', 'files' => true]) !!}
                            ...
                            <div class="col-12 table-responsive">
                                <div class="row pt-2">
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control form-control-lg my-image" type="text" id="" name="title" placeholder="Enter Title" value="{{ $new->title }}">
                                    </div>
                                ...
                                <div class="row pt-2">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="content" id="body1" cols="30" rows="5" class="form-control form-control-lg" placeholder="">{!! $new->content !!}</textarea>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 pt-3 pt-md-0">
                                        ...
                                        <select name="author_id" id="author_id" class="form-control">
                                            @foreach($authors as $author)
                                                <option value="{{ $author->id }}" {{ $new->author_id == $author->id ? 'selected' : '' }}>
                                                    {{ $author->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mt-3">
                                    <div class="col-6 col-md-2 pt-3 pt-md-0">
                                        ...
                                        <input type="date" name="published_at" id="published_at" class="form-control" value="{{ $new->published_at ? \Carbon\Carbon::parse($new->published_at)->format('Y-m-d') : '' }}">
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-sm-6">
                                    ...
                                    <select id="status" name="status" class="form-select" aria-label="Select the status type" required>
                                        ...
                                        <option value="{{$in2}}" @if($new->status == $in2) selected @endif>{{$val2}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
