                ...
                <div class="row">
                    <div class="card-heading d-flex justify-content-between">
                        <div>
                            <h4>News Lists</h4>
                            <p>
                                You can search the news by <a href="#" class="card-heading-link">name</a> and
                    ...
                    {!! Form::open(['url' => 'super-admin/news', 'method' => 'GET']) !!}
                    <div class="row">
                        <div class="col-md-11">
                            <div class="row">
                        ...
                        <div class="card-wrap form-block p-0">
                            <div class="block-header bg-header d-flex justify-content-between p-4">
                                ...
                                <div class="add-button">
                                    <a class="nav-link" href="{{url('super-admin/news/create')}}"><i class="fa-solid fa-book-open"></i>&nbsp;&nbsp Add News</a>
                                </div>
                            </div>
                                                ...
                                                <table class="table" id="">
                                                    ...
                                                    <tbody id="student_list">
                                                        ...
                                                        <tr id="my-table-tr-{{$new->id}}">
                                                            ...
                                                            <td class="text-center">{{config('custom.status')[$new->status]}}</td>
                                                            <td class="action-icons">
                                                                <ul class="icon-button d-flex">
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-item" href="{{url('super-admin/news/'.$new->id.'/edit')}}" role="button"><i class="fa-solid fa-pen" data-bs-toggle="tooltip" data-bs-title="Edit"></i></a>
                                                                    </li>

                                                                    <li>
                                                                        <a class="dropdown-item" href="{{url('super-admin/news/'.$new->id)}}" role="button"><i class="fa-solid fa-eye" data-bs-toggle="tooltip" data-bs-title="Show"></i></a>
                                                                    </li>

                                                                    <li>
                                                                        <a class="dropdown-item" href="{{ url('super-admin/news/delete/' . $new->id) }}"><i class="fa-solid fa-trash" data-bs-toggle="tooltip" data-bs-title="Delete"></i></a>
                                                                    </li>
