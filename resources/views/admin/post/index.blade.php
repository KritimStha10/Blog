                ...
                <div class="row">
                    <div class="card-heading d-flex justify-content-between">
                        <div>
                            <h4>Posts Lists</h4>
                            <p>
                                You can search the post by <a href="#" class="card-heading-link">name</a> and
                    ...
                    {!! Form::open(['url' => 'super-admin/posts', 'method' => 'GET']) !!}
                    <div class="row">
                        <div class="col-md-11">
                            <div class="row">
                        ...
                        <div class="card-wrap form-block p-0">
                            <div class="block-header bg-header d-flex justify-content-between p-4">
                                ...
                                <div class="add-button">
                                    <a class="nav-link" href="{{url('super-admin/posts/create')}}"><i class="fa-solid fa-book-open"></i>&nbsp;&nbsp Add Posts</a>
                                </div>
                            </div>
                                                ...
                                                <table class="table" id="">
                                                    ...
                                                    <tbody id="student_list">
                                                        ...
                                                        <tr id="my-table-tr-{{$post->id}}">
                                                            ...
                                                            <td class="text-center">{{config('custom.status')[$post->status]}}</td>
                                                            <td class="action-icons">
                                                                <ul class="icon-button d-flex">
                                                                    <li>
                                                                        <a class="dropdown-item" href="{{url('super-admin/posts/'.$post->id)}}" role="button"><i class="fa-solid fa-eye" data-bs-toggle="tooltip" data-bs-title="Show"></i></a>
                                                                    </li>



                                                                    <li>
                                                                        <a class="dropdown-item" href="{{url('super-admin/posts/'.$post->id.'/edit')}}" role="button"><i class="fa-solid fa-pen" data-bs-toggle="tooltip" data-bs-title="Edit"></i></a>
                                                                    </li>



                                                                    <li>
                                                                        <a class="dropdown-item" href="{{ url('super-admin/posts/delete/' . $post->id) }}"><i class="fa-solid fa-trash" data-bs-toggle="tooltip" data-bs-title="Delete"></i></a>
                                                                    </li>
